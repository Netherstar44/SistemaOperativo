...
export const historyNodes: HistoryNode[] = [
  {
    ...
    context: 'Antes de contar con sistemas operativos, la programación exigía manipular interruptores, cables o tarjetas perforadas directamente sobre el hardware sin capas de abstracción (Salgado, 2024).',
    technical: 'Programación directa en lenguaje de máquina y tarjetas perforadas inspiradas en los telares de Jacquard. Sin multiprogramación, memoria virtual ni gestión de archivos (Tanenbaum, 2003).',
    ...
    citation: '(Salgado, 2024; Tanenbaum, 2003)',
  ...
  },
  {
    ...
    context: 'Surgió por la necesidad de automatizar la carga secuencial de tareas en el mainframe IBM 704, evitando la intervención manual permanente entre trabajos (Salgado, 2024).',
    technical: 'Sistema de procesamiento por lotes (Batch Processing) secuencial en cinta magnética para IBM 704 (Salgado, 2024).',
  ...
  },
  {
    ...
    context: 'Las empresas necesitaban proteger inversiones en hardware e IBM introdujo la multiprogramación con la serie System/360 (IBM, 2025).',
    technical: 'Multiprogramación, circuitos integrados, spooling y gestión avanzada de recursos en una máquina con un solo procesador (IBM, 2025).',
  ...
  },
  {
    ...
    context: 'En 1965 iniciaron las discusiones en el MIT, Bell Labs y GE para construir una utilidad computacional permanente (Multicians, 2000).',
    technical: 'Introdujo memoria virtual, anillos de protección, segmentación y la jerarquía de archivos original (Multicians, 2000).',
  ...
  },
  {
    ...
    context: 'Ken Thompson y Dennis Ritchie desarrollaron Unix en un PDP-7/PDP-11 y lo reescribieron en lenguaje C (Ritchie, 1993; Salgado, 2024).',
    technical: 'Sistema de archivos jerárquico mejorado, tuberías (pipes), permisos, shell de comandos y abstracción limpia del hardware (IBM, 2025).',
    ...
    citation: '(IBM, 2025; Ritchie, 1993; Salgado, 2024)',
  ...
  },
  {
    ...
    context: 'Digital Equipment Corporation (DEC) diseñó VAX para suceder a sus minicomputadores PDP con enfoque corporativo (Tanenbaum, 2003).',
    technical: 'Sistema de archivos Files-11, memoria virtual con paginación limpia y APIs que inspiraron a Windows NT (IBM, 2025).',
    ...
    citation: '(IBM, 2025; Tanenbaum, 2003)',
  ...
  },
  {
    ...
    context: 'Microsoft licenció 86-DOS y lo adaptó para IBM, estableciendo la base del software de computadoras personales (Tanenbaum, 2003).',
    technical: 'Sistema de archivos FAT, intérprete de comandos COMMAND.COM y arquitectura modular básica (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'El equipo de Macintosh diseñó un sistema operativo completamente centrado en la interacción gráfica de usuario (Tanenbaum, 2003).',
    technical: 'Macintosh File System (MFS), gestor de recursos gráficos y multitarea cooperativa básica (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Steve Jobs fundó NeXT Inc. para crear estaciones de trabajo avanzadas; su software se convirtió en el cimiento de Apple a su regreso (Tanenbaum, 2003).',
    technical: 'Microkernel Mach con subsistema BSD, Display PostScript y frameworks de desarrollo orientados a objetos (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Iniciado para completar el sistema libre GNU bajo un diseño vanguardista de microkernel (Tanenbaum, 2003).',
    technical: 'Colección de servidores (traductores) sobre el microkernel GNU Mach con interfaz POSIX (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Andrew S. Tanenbaum creó MINIX como un Unix de código accesible para cursos universitarios (Tanenbaum, 2003).',
    technical: 'Arquitectura de microkernel, servidores en espacio de usuario y paso explícito de mensajes (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Torvalds buscaba aprender sobre la arquitectura 80386 y publicó el código libremente para recibir colaboraciones (Salgado, 2024).',
    technical: 'Kernel monolítico modular, multitarea preventiva, memoria virtual, controladores y licencia GPL (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Microsoft necesitaba una plataforma robusta para estaciones de trabajo y servidores (IBM, 2025).',
    technical: 'Kernel híbrido, memoria protegida, capa de abstracción de hardware (HAL) y soporte multiprocesador (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Apple obtuvo la base técnica para renovar Mac OS clásico usando la tecnología de NeXTSTEP tras el regreso de Steve Jobs (IBM, 2025).',
    technical: 'XNU (Mach + BSD), memoria protegida, multitarea preventiva y entorno gráfico Aqua (Tanenbaum, 2003).',
    ...
    citation: '(Tanenbaum, 2003; IBM, 2025)',
  ...
  },
  {
    ...
    context: 'Ian Murdock propuso un proyecto abierto independiente de empresas comerciales (Fernández-Sanguino et al., 1999).',
    technical: 'Paquetes .deb, gestor de paquetes APT y estrictas políticas de control de calidad (Fernández-Sanguino et al., 1999).',
    ...
    citation: '(Fernández-Sanguino et al., 1999)',
  ...
  },
  {
    ...
    context: 'Empresas e instituciones requerían soporte técnico y estabilidad garantizada para ejecutar Linux (Tanenbaum, 2003).',
    technical: 'Sistema RPM, SELinux, utilidades administrativas y contribución activa al kernel (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Canonical identificó la necesidad de una distribución Linux amigable y fácil de mantener (Canonical Ubuntu, 2010).',
    technical: 'Gestión APT, lanzamientos periódicos cada 6 meses, versiones LTS y entorno GNOME (Canonical Ubuntu, 2010).',
    ...
    citation: '(Canonical Ubuntu, 2010)',
  ...
  },
  {
    ...
    context: 'El consorcio Symbian (Nokia, Ericsson, Motorola) creó la plataforma móvil pionera (Tanenbaum, 2003).',
    technical: 'Arquitectura microkernel orientada a objetos y gestión estricta de energía y memoria (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Google y la Open Handset Alliance crearon una plataforma abierta adaptada a dispositivos táctiles (IBM, 2025).',
    technical: 'Kernel Linux modificado, comunicación IPC Binder, aislamiento por aplicación y runtime Android (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'El iPhone exigió adaptar tecnologías de escritorio a un dispositivo móvil cerrado y gestual (IBM, 2025).',
    technical: 'Núcleo XNU derivado de Darwin/macOS, sandboxing, aceleración por hardware y firma de código (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Los centros de datos masivos requerían un sistema flexible, automatizable y de código abierto (IBM, 2025).',
    technical: 'Namespaces, cgroups, virtualización KVM, eBPF y redes programables (Salgado, 2024).',
    ...
    citation: '(IBM, 2025; Salgado, 2024)',
  ...
  },
  {
    ...
    context: 'Commodore lanzó el Amiga orientándolo al desarrollo multimedia y creativo (Tanenbaum, 2003).',
    technical: 'Núcleo Exec multitarea, librerías compartidas e interfaz Intuition (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'Be Inc. buscó superar los cuellos de botella de los sistemas de escritorio tradicionales (Tanenbaum, 2003).',
    technical: 'Kernel multihilo multiprocesador y sistema de archivos BFS (Tanenbaum, 2003).',
  ...
  },
  {
    ...
    context: 'AT&T buscaba estandarizar una versión comercial unificada de Unix (Ritchie, 1993).',
    technical: 'IPC (System V IPC), colas de mensajes, semáforos y memoria compartida (IBM, 2025).',
    ...
    citation: '(IBM, 2025; Ritchie, 1993)',
  ...
  },
  {
    ...
    context: 'Diseñado para aportar multitarea preventiva y protección de memoria al PC de escritorio (IBM, 2025).',
    technical: 'Multitarea preventiva, modo protegido de 16/32 bits y Presentation Manager (IBM, 2025).',
  ...
  },
  {
    ...
    context: 'IBM requería un entorno Unix de alto rendimiento para sus procesadores POWER (IBM, 2025).',
    technical: 'Sistema de archivos JFS, volumen LVM y capacidades de virtualización avanzada (IBM, 2025).',
  ...
  },
  {
    ...
    context: 'Diseñado para impulsar la Web en servidores SPARC multi-procesador (Tanenbaum, 2003).',
    technical: 'Sistema de archivos ZFS, contenedores Solaris Zones y herramienta de trazado DTrace (IBM, 2025).',
  ...
  },
  {
    ...
    context: 'El equipo original de Bell Labs buscó evolucionar los conceptos de Unix hacia redes distribuidas (Ritchie, 1993).',
    technical: 'Protocolo 9P, per-process namespaces y sistema de archivos virtual /net (IBM, 2025).',
    ...
    citation: '(Ritchie, 1993; IBM, 2025)',
