...
function App() {
  return <QueryClientProvider client={queryClient}><TooltipProvider><WouterRouter base={import.meta.env.BASE_URL.replace(/\/$/, '')}><Intro /><Router /></WouterRouter><Toaster /></TooltipProvider></QueryClientProvider>;
}
