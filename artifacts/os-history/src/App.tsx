...
function Intro() {
  ...
  return <div className={`intro-screen ${dismissed ? 'is-dismissed' : ''}`} aria-hidden={dismissed}>
    <div className="intro-content">
      <div className="intro-kicker eyebrow">Línea del Tiempo Digital / Sala 01</div>
      <h1 className="intro-title">La historia de los<br /><em>sistemas operativos.</em></h1>
      <p className="intro-subtitle">De los primeros mainframes al kernel que mueve gran parte del mundo digital.</p>
      
      <div className="intro-action-row">
        <button className="intro-button" onClick={enter} data-testid="button-enter-museum">
          Explorar la historia <span>↗</span>
        </button>
        <span className="intro-enter-hint">o pulsa <strong>Enter</strong></span>
      </div>

      <div className="intro-graph">
        <svg viewBox="0 0 840 88" preserveAspectRatio="none">
          <path d="M0 69 C130 69 139 21 245 43 S370 79 463 35 S628 12 840 25" />
          <path d="M0 18 C115 11 192 57 298 45 S473 5 585 47 S728 76 840 53" />
          <circle cx="0" cy="69" r="3" />
          <circle cx="245" cy="43" r="3" />
          <circle cx="463" cy="35" r="3" />
          <circle cx="690" cy="24" r="3" />
          <circle cx="840" cy="25" r="3" />
        </svg>
      </div>
